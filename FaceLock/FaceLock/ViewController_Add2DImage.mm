        ...
        dispatch_async(face_recognition_queue, ^{
            ...
            for(int i =0; i <_faces.size(); i++){
                ...
                if (_imagename_count<=50) {
                    NSString* imagename = [NSString stringWithFormat:@"%@%d.jpg", self.UserName, _imagename_count];
                    
                    while ([Setting_ImageManagement ImageExist:imagename]) {
                        _imagename_count++;
                        imagename = [NSString stringWithFormat:@"%@%d.jpg", self.UserName, _imagename_count];
                    }
